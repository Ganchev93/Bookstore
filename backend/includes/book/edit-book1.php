...
$author = mysql_entities_fix_string($conn, $_POST['author_id']);
$category = mysql_entities_fix_string($conn, $_POST['category_id']);
...
$publisher = mysql_entities_fix_string($conn, $_POST['publisher_id']);
...
if (($image == "" && $flag == "") || ($image != "" && $flag == "" )) {
    ...
    " price='$price', publisher_id='$publisher', created_at='$date_created' WHERE id = $book_id";
